...
public class ListViewSwipeGesture implements OnTouchListener {
    ...
    private SwipeCallback tcallbacks;
    ...
    public ListViewSwipeGesture(ListView listView, SwipeCallback Callbacks, Activity context) {
            ...
            public void onAnimationEnd(Animator animation) {
                ...
                animator.addListener(new AnimatorListenerAdapter() {
                    ...
                    public void onAnimationEnd(Animator animation) {
                        ...
                        tcallbacks.onDismiss(mListView, dismissPosition);
                        ...
                        switch (v.getId()) {
                            case 111111:
                                if (SwipeType == Dismiss) {
                                    ...
                                    tcallbacks.performFirstAction(temp_position);
                                return true;
                            case 222222:
                                tcallbacks.performSecondAction(temp_position);
                                return true;
                        }
                    }
                }
