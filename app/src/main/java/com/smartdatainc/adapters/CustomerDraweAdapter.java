 ...
 */
public class CustomerDraweAdapter extends ArrayAdapter<String> {
     ...
     */
    public CustomerDraweAdapter(Context context, int resource, ArrayList<String> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (position == 3) {
            holder.drawerBackGround.setBackgroundColor(getContext().getResources().getColor(R.color.lightbrown));
            holder.image.setBackgroundResource(R.drawable.call_history_icon);
